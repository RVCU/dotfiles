...
" Single mappings
let g:which_key_map['n'] = [ ':CHADopen --nofocus'        , 'CHADtree' ]
let g:which_key_map['f'] = [ ':Files'                     , 'search files' ]
let g:which_key_map['c'] = [ ':Commits'                   , 'search commits' ]
let g:which_key_map['t'] = [ ':PRg'                        , 'search text' ]
let g:which_key_map['b'] = [ ':Buffers'                   , 'buffers' ]
let g:which_key_map['h'] = [ ':History'                   , 'file history' ]
...
" Show commands.
nnoremap <silent><nowait> <space>c  :<C-u>Cheat<cr>
